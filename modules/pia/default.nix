# Imported and modified from https://github.com/tadfisher/flake/blob/ac87a52f3813b1196522710e8e5e01c2094dfbb7/nixos/modules/pia-vpn.nix

{ config, lib, pkgs, ... }:
let
  cfg = config.services.pia-vpn;
  pia-foss = pkgs.fetchFromGitHub {
    owner = "pia-foss";
    repo = "manual-connections";
    rev = "e956c57849a38f912e654e0357f5ae456dfd1742";
    hash = "sha256-otDaC45eeDbu0HCoseVOU1oxRlj6A9ChTWTSEUNtuaI=";
  };
in
with lib;

{
  options.services.pia-vpn = {
    ...
    certificateFile = mkOption {
      type = types.path;
      default = "${pia-foss}/ca.rsa.4096.crt";
      description = ''
    ...
    environmentFile = mkOption {
      type = types.path;
      default = config.scott.sops.envFiles.pia.path;
      description = ''
